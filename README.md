...
- 插件清单：
    - 应用：[Samba4](https://github.com/openwrt/luci/tree/openwrt-21.02/applications/luci-app-samba4)、[WOL-plus](https://github.com/msylgj/OpenWrt_luci-app/tree/main/luci-app-services-wolplus)、[ShellClash](https://github.com/juewuy/ShellClash)、[frpc](https://github.com/fatedier/frp)、Docker
